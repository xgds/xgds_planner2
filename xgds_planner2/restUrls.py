...
urlpatterns = [
    ...
    url(r'^plan/export/ajaxByPK/(?P<uuid>[\w-]+)/(?P<name>[^/]+)$', views.planExport, {'isAjax': True, 'idIsPK': True}, name='planner2_planExport_ajax'),
    ...
    url(r'^reportExportStatus/$', views.reportExportStatus, {}, name='planner2_report_export_status'),
